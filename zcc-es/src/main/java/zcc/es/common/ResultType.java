...
public enum  ResultType {
    ...
    FAILURE(60210, "", "请求失败"),
    NO_TOKEN(60310, "", "未登录"),
    QUERY_RESULT_NULL(60601, "", "无查询结果"),
    ALREADY_EXIST(60602, "", "记录已存在"),
    BAD_REQUEST_PARAM(60603, "", "请求参数错误"),
    INTERNAL_ERROR(60500, "", "服务器内部错误"),
    OP_DB_FAIL(60700, "", "操作数据库失败"),
    DATA_NO_EXISTS(60600, "", "数据记录不存在"),
    CREATE_FAILURE(60604, "", "创建失败"),
    UPDATE_FAILURE(60605, "", "更新失败"),
    DEL_FAILURE(60606, "", "删除失败"),
    QUERY_FAILURE(60607, "", "查询失败"),
    UPLOAD_FAILURE(60608, "", "上传失败"),
    TYPE_EMPTY(70000, "", "类型为空"),
    NO_TYPE(70001, "", "不支持此类型预览");

    private Integer code;
    private String desc;
    private String endesc;

    private ResultType(Integer code, String endesc, String desc) {
        this.code = code;
        this.desc = desc;
        this.endesc = endesc;
    }
